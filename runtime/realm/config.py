...
ACHIEVEMENTS = [
    ...
    },
    {
        "id":    "five_orders",
        "icon":  "✦",
        "name":  "Seven Orders Stand",
        "desc":  "All seven orders have opened their ledgers",
        "condition": {"type": "all_divisions_xp_gt", "value": 0},
        "chronicle_lore": "All seven orders of the realm have opened their ledgers. The full command structure is active.",
    },
    {
        "id":    "realm_commander",
        "icon":  "🌟",
